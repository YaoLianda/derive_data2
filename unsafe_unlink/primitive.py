...
},#dbf malloc
{
    ...
    "primitive":[
        ...
        {"index":1,"oper_type":"malloc","size":4665,"isNoise":"True"}
    ]#dbf free
},
{
    "index":2,
...
},
{
    ...
    "primitive":[
        {"index":0,"oper_type":"read","object":(0,0),"size":16,"isNoise":"True"},
        {"index":1,"oper_type":"malloc","size":4665,"isNoise":"True"},
        {"index":2,"oper_type":"malloc","size":4665,"isNoise":"True"}
    ]
},
{
    "index":5,
...
vuln =[{"type":"hof","producer":[(0,0),(2,0)]},
       ...
       {"type":"hof","producer":[(8,0),(18,0)]},
        {"type":"hof","producer":[(8,0),(28,0)]},
       {"type":"hof","producer":[(12,0),(24,0)]},
         {"type":"hof","producer":[(12,0),(27,0)]},
       {"type":"hof","producer":[(11,0),(25,0)]},
        {"type":"hof","producer":[(11,0),(26,0)]}
       ]